...
function Search() {
  ...
  return (
    <div className="bg-gradient-to-l from-pink-300 to-purple-400 h-[599px] overflow-auto">
    ...
    <div className="m-10">
      {filteredRequests.length > 0 ? (
        filteredRequests.map((request) => (
          <div key={request.requestNumber} className="bg-white p-5  m-10 mb-4 rounded shadow-md ">
        ...
        <p className="text-center text-white">No requests found for this city.</p>
      )}
    </div>
